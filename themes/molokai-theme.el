...
(custom-theme-set-faces
 'molokai
 ;; 背景・文字・カーソル
 '(cursor ((t (:foreground "dark red"))))
 '(default ((t (:background "#1B1D1E" :foreground "#F8F8F2"))))

 ;; 選択範囲
 '(region ((t (:background "gray55"))))
 ...
 ;; 変数名・変数の内容
 '(font-lock-variable-name-face ((t (:foreground "magenta")))) ;;int num の num とか
 '(font-lock-string-face ((t (:foreground "#E6DB74")))) ;;"この中の色"

 ;; 特定キーワード
 '(font-lock-keyword-face ((t (:foreground "maroon")))) ;;予約語

 ;; Boolean
 '(font-lock-constant-face((t (:foreground "#AE81BC")))) ;;NULL とか。 いまいちよーわからん

 ;; 括弧
 '(show-paren-match-face ((t (:foreground "#1B1D1E" :background "yellow"))))
